...
public class BackTitleVerification extends base {
	WebDriver driver;
	private static Logger log=LogManager.getLogger(BackTitleVerification.class.getName());
	@BeforeTest
	...
	public void backTitleVerification(String Username, String Password, String Text) throws IOException {
